...
class DriveScienceListener(Node):
    ...
    def __init__(self):
        ...
        self.subscriber_servo1 = self.create_subscription(Int8,"science/servos", self.callbackservo1,10)
        self.subscriber_servo1
        self.subscriber_servo2 = self.create_subscription(Int8,"science/servos", self.callbackservo2,10)
    ...
    def callbackservo1(self,data):
        self.servo1_data = Int8(data.data)

    def callbackservo2(self,data):
        self.servo2_data = Int8(data.data)
    
    def callbackelevator(self,data):
        self.elevator_data = Int8(data.data)
